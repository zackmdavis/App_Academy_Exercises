...
'It is totally a question that you would imagine someone like you wondering about', 1);

INSERT INTO questions (id, title, body, author_id)
VALUES (2, 'Is the body of one John Brown a-mouldering in the grave?',
'It has been a while', 2);

INSERT INTO questions (id, title, body, author_id)
VALUES (3, 'I just met you, and this is crazy, but ...?',
'Here is my number, so call me maybe', 1);
